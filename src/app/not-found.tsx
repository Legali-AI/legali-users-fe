      ...
      <div className="mx-auto flex w-full max-w-2xl flex-col items-center gap-8 text-center">
        ...
        <div className="relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <span className="text-4xl font-semibold text-brand-navy sm:text-5xl">Page Not Found</span>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-base text-brand-navy/70">Let's get you back on track to access justice.</p>
        </div>
        ...
        <div className="mt-8 flex flex-col gap-3">
          <p className="text-sm font-medium text-brand-navy/70">You might be looking for:</p>
