  ...
  return (
    <QueryProvider>
      ...
      <SidebarProvider className="h-screen bg-brand-gray-50 py-3 lg:py-5">
        <AppSidebar />
        <div className="flex min-w-0 flex-1 flex-col gap-3 px-3 lg:gap-5 lg:pr-5 lg:pl-0">
          <DynamicHeader />

          <SidebarInset
            className="flex min-w-0 flex-1 flex-col gap-4 overflow-hidden overflow-y-auto rounded-lg border border-white-400 p-4 lg:p-6"
            style={{
