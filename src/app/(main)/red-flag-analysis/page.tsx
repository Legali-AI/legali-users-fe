...
const FEATURES = [
  {
    ...
    title: "Upload case",
    description: "Upload your file or enter case details. Legali automatically highlights clauses, conflicts, and trends that may require attention.",
  ...
  },
  {
    ...
    highlight: "Legali AI",
    highlightDescription: "Organize evidence, draft documents, connect with affordable attorneys, and fund your case — all on one secure platform.",
  },
  {
    id: 3,
    ...
    recommendations: [
      { title: "Clarify Payment Terms", description: "Clause 4 contains vague wording about due dates, rewrite for clarity." },
      { title: "Compliance Check Needed", description: "Ask a compliance officer to review the privacy policy in section 8." },
    ],
  },
];
            ...
            >
              <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-12">
                ...
                <div className="flex flex-col justify-center gap-4">
                  <h3 className="text-2xl font-semibold text-brand-navy sm:text-3xl md:text-4xl">
                    {feature.title}
                  </h3>
                  <p className="text-base text-brand-navy/80 sm:text-lg md:text-xl">
                    {feature.description}
                  </p>
