...
export default function AboutUsSection() {
  return (
    <section
      ...
      {/* Intro */}
      <div className="w-full max-w-4xl space-y-6 sm:space-y-7" data-aos="fade-up">
        <H4
          id="about-heading"
          level="h2"
          align="center"
        ...
        <P align="center" className="mx-auto max-w-3xl text-base text-brand-slate sm:text-lg lg:text-xl">
          That&apos;s exactly why{" "}
          <Span className="text-[#2F7D99] lg:text-xl" weight="semibold">
            Legali
          </Span>{" "}
          exists—to level the playing field with accessible legal tools and guidance.
        </P>
        <Button
          asChild
          size="lg"
      ...
      {/* Supporting copy */}
      <div className="w-full max-w-5xl space-y-4 sm:space-y-5" data-aos="fade-up" data-aos-delay="150">
        <H4
          level="h2"
          align="center"
          weight="semibold"
        ...
        <P align="center" className="mx-auto max-w-3xl text-base text-brand-slate/80 sm:text-lg lg:text-lg">
