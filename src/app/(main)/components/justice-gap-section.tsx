...
export default function JusticeGapSection() {
  return (
    <section
      ...
      <header className="space-y-4 sm:space-y-5 md:space-y-6" data-aos="fade-up" data-aos-duration="600">
        <H3
        ...
        <P
          ...
          In America&apos;s legal system, one thing determines your outcome more than the facts of your case.
        </P>
      </header>
      ...
      <div
        ...
        <dl className="grid gap-10 sm:grid-cols-3 sm:gap-0 sm:divide-x sm:divide-white/15">
          {JUSTICE_GAP_STATS.map(stat => (
            <div key={stat.value} className="flex flex-col items-center gap-4 text-center sm:px-6 md:px-10 lg:gap-5">
              <dt>
              ...
              <dd>
                <P level="body" className="text-center text-sm text-white/80 sm:text-base md:text-lg lg:text-xl">
                  {stat.description}
                </P>
              </dd>
            </div>
