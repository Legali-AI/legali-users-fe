...
import { HERO_CONTENT } from "../../../../data/smart-legal-drafter.data";
      ...
      <div className="mx-auto flex w-full max-w-5xl flex-col items-center gap-8 text-center">
        ...
        <div
          ...
          <Button asChild variant="gradient-teal" size="xl" weight="semibold">
            <Link href={HERO_CONTENT.ctaPrimary.href}>{HERO_CONTENT.ctaPrimary.text}</Link>
          </Button>
          <Button asChild variant="outline" size="xl" weight="semibold">
            <Link href={HERO_CONTENT.ctaSecondary.href}>{HERO_CONTENT.ctaSecondary.text}</Link>
          </Button>
        </div>
      </div>
